# React Native Push Alarm Notifications (https://www.npmjs.com/package/react-native-push-alarm-notification)
...
`npm install --save react-native-push-alarm-notification` or `yarn add react-native-push-alarm-notification`

`react-native link react-native-push-alarm-notification`
...
```xml
    ...
    <application ....>
        <meta-data  android:name="com.hnr.reactnativepushalarmnotification.notification_channel_name"
                android:value="YOUR NOTIFICATION CHANNEL NAME"/>
        <meta-data  android:name="com.hnr.reactnativepushalarmnotification.notification_channel_description"
                    android:value="YOUR NOTIFICATION CHANNEL DESCRIPTION"/>
        <!-- Change the resource name to your App's accent color - or any other color you want -->
        <meta-data  android:name="com.hnr.reactnativepushalarmnotification.notification_color"
        ...
        <receiver android:name="com.hnr.reactnativepushalarmnotification.modules.RNPushAlarmNotificationPublisher" />
        <receiver android:name="com.hnr.reactnativepushalarmnotification.modules.RNPushAlarmNotificationBootEventReceiver">
            <intent-filter>
                <action android:name="android.intent.action.BOOT_COMPLETED" />
            </intent-filter>
        </receiver>
        <service android:name="com.hnr.reactnativepushalarmnotification.modules.RNPushAlarmNotificationRegistrationService"/>

        <!-- < Only if you're using GCM or localNotificationSchedule() > -->
        <service
            android:name="com.hnr.reactnativepushalarmnotification.modules.RNPushAlarmNotificationListenerServiceGcm"
        ...
        <!-- < Else > -->
        <service
            android:name="com.hnr.reactnativepushalarmnotification.modules.RNPushAlarmNotificationListenerService"
            android:exported="false" >
            <intent-filter>
...
```gradle
...
include ':react-native-push-alarm-notification'
project(':react-native-push-alarm-notification').projectDir = file('../node_modules/react-native-push-alarm-notification/android')
```
...
```java
import com.hnr.reactnativepushalarmnotification.ReactNativePushAlarmNotificationPackage;  // <--- Import Package
...
public class MainApplication extends Application implements ReactApplication {
  ...
  private final ReactNativeHost mReactNativeHost = new ReactNativeHost(this) {
      ...
      return Arrays.<ReactPackage>asList(
          ...
          new ReactNativePushAlarmNotificationPackage() // <---- Add the Package
      );
    }
  };
...
```javascript
var PushNotification = require("react-native-push-alarm-notification");
...
PushNotification.localNotification({
    ...
    soundName: 'default', // (optional) Sound to play when the notification is shown. Value of 'default' plays the default sound. It can be set to a custom sound such as 'android.resource://com.xyz/raw/my_sound'. It will look for the 'my_sound' audio file in 'res/raw' directory and play it. default: 'default' (default alarm sound will be played)
...
```
import PushNotificationAndroid from 'react-native-push-alarm-notification'
