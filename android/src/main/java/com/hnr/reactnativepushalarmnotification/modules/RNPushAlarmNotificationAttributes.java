...
public class RNPushAlarmNotificationAttributes {
    ...
    private RNPushAlarmNotificationAttributes(JSONObject jsonObject) {
        try {
    ...
    @NonNull
    public static RNPushAlarmNotificationAttributes fromJson(String notificationAttributesJson) throws JSONException {
        JSONObject jsonObject = new JSONObject(notificationAttributesJson);
        return new RNPushAlarmNotificationAttributes(jsonObject);
    }
