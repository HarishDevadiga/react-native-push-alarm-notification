...
public class RNPushAlarmNotificationListenerService extends FirebaseMessagingService {
    ...
    private void handleRemotePushNotification(ReactApplicationContext context, Bundle bundle) {
        ...
        RNPushAlarmNotificationJsDelivery jsDelivery = new RNPushAlarmNotificationJsDelivery(context);
        ...
        RNPushAlarmNotificationHelper pushNotificationHelper = new RNPushAlarmNotificationHelper(applicationContext);
